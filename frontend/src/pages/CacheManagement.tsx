  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'var(--theme-surface-1)', border: '1px solid var(--theme-border)', borderRadius: '12px',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
          ...
          <span style={{ fontSize: '14px', fontWeight: 600, color: 'var(--theme-tx-primary)' }}>{message}</span>
        </div>
        {detail && (
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px' }}>
          <button
            onClick={onCancel}
            style={{
              padding: '7px 16px', borderRadius: '7px', border: '1px solid var(--theme-border)',
              background: 'transparent', color: 'var(--theme-tx-secondary)', fontSize: '12px',
          ...
          <button
            ...
            style={{
              ...
              background: danger ? '#ef4444' : 'var(--theme-accent)', color: 'var(--theme-tx-primary)',
...
export default function CacheManagement() {
  ...
  return (
    <div style={{
      minHeight: '100vh', background: 'var(--theme-bg)', color: 'var(--theme-tx-primary)',
      fontFamily: 'JetBrains Mono, Fira Code, Consolas, monospace',
    }}>
      ...
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Database size={15} style={{ color: 'var(--theme-accent)' }} />
            <span style={{ fontSize: '13px', color: 'var(--theme-tx-secondary)' }}>
              <span style={{ fontSize: '20px', fontWeight: 700, color: 'var(--theme-tx-primary)' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              ...
              style={{
                ...
                padding: '7px 14px', borderRadius: '7px', border: '1px solid var(--theme-border)',
                background: 'var(--theme-surface-2)', color: loading ? 'var(--theme-tx-secondary)' : 'var(--theme-tx-primary)',
            ...
            <button
              ...
              style={{
                ...
                background: 'rgba(239,68,68,0.08)', color: loading || entries.length === 0 ? 'var(--theme-tx-muted)' : '#f87171',
        ...
        {!loading && entries.length === 0 && (
          <div style={{
            ...
            border: '1px dashed var(--theme-border)', padding: '80px 24px', textAlign: 'center',
          }}>
            <div style={{
              ...
              <Database size={22} style={{ color: 'var(--theme-tx-muted)' }} />
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {[1, 2, 3].map(i => (
              <div key={i} style={{
                ...
                background: 'var(--theme-surface-1)', padding: '20px', opacity: 0.5,
              }}>
                <div style={{ height: '14px', background: 'var(--theme-border)', borderRadius: '4px', width: '60%', marginBottom: '12px' }} />
                <div style={{ height: '10px', background: 'var(--theme-border)', borderRadius: '4px', width: '90%' }} />
              </div>
            ))}
          </div>
        )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {entries.map(entry => (
              <div
                ...
                style={{
                  borderRadius: '10px', border: '1px solid var(--theme-border)',
                  background: 'var(--theme-surface-1)', padding: '20px',
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px' }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ marginBottom: '12px' }}>
                      <span style={{
                        fontSize: '10px', fontWeight: 600, color: 'var(--theme-accent)',
                        letterSpacing: '0.08em', textTransform: 'uppercase',
                      }}>
                        Query
                      </span>
                      <p style={{
                        margin: '4px 0 0', fontSize: '13px', color: 'var(--theme-tx-primary)',
                    ...
                    <div>
                      ...
                      <pre style={{
                        margin: '4px 0 0', fontSize: '11px', color: 'var(--theme-tx-secondary)',
                    ...
                    <div style={{ marginTop: '10px' }}>
                      <span style={{ fontSize: '10px', color: 'var(--theme-tx-muted)', fontFamily: 'monospace' }}>
